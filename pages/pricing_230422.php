<?php
     ...
     * Prising Starts
     */
    add_action('m_pricing', 'm_pricing');
    function m_pricing() {
        $args = [
            'post_type' => 'mpricing',
            'posts_per_page'         => 100,
            ...
            <div class="col-md-6 offset-3">
                <div class="accordion" id="accordionExample">
                  <div class="card">
                    ...
                    <!-- <div id="<?php //echo $search_content; ?>" class="collapse <?php //if(isset($custom['show'])) {
                          // echo $custom['show'][0];
                        //}?>" data-parent="#accordionExample"> -->
                        <div id="<?php echo $search_content; ?>" class="collapse <?php print_r($custom['show'][0]); ?>" data-parent="#accordionExample">
                      <div class="card-body">
                      <?php //the_content(); ?>
