                          ...
                          <div class="btn-div">
                            <form class="form-horizontal" id="form" method="POST" action="" enctype="multipart/form-data">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-12">
                                      <p class="form-control-static"><input type="text" class="form-control" name="addresstwo" /></p>
                                  </div>
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-sm-12">
                                    ...
                                    <?php 
										if($contents[2] == 'video'){
                                          echo "<p style='color:red;'>mp4, env files Allowed!</p>";
                                        }else if($contents[2] == 'image'){
                                          echo "<p style='color:red;'>Only jpg, gif, jpeg, png files Allowed!</p>";
                                        }
                              ...
                              <div class="form-group">
                                  <div class="btn-select-div">
                                      ...
                                      <input type="hidden" name="contents" value="<?php echo $contents[2]; ?>" />
...
?>
    <script>
      $(document).ready(function (e) {
       ...
       //$("#doller1_64").trigger("click");
        if ($("#doller1_64").is(":checked")) {
          setTimeout(function() {
            $("#doller1_64").trigger("click");
          }, 30000);
        }
